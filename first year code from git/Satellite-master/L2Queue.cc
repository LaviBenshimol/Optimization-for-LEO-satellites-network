...
void L2Queue::startTransmitting(cMessage *msg)
{
    ...
    EV << "[+] parentDispStr Before Change =  " << parentDispStr << endl;
    EV << "[+] random_number =  " << random_number << endl;
    ...
    EV << "[+] tempColor =  " << tempColor << endl;

    parentDispStr.setTagArg("i",0,"device/satellite");
    parentDispStr.setTagArg("i",1,tempColor);

    EV << "[+] parentDispStr After Change =  " << parentDispStr << endl;
