...
// Set pointer of topology
void Packet::setTopologyVar(omnetpp::cTopology *tp)
{
    this->topo = tp;
}

void Packet::sethasInitTopo(int has)
{
    this->hasInitTopo = has;
}

int Packet::gethasInitTopo()
{
...
void Packet::setpacketType(int packType)
{
    this->packetType = packType;
}

omnetpp::cTopology * Packet::getTopologyVar()
{
    return this->topo;
}
