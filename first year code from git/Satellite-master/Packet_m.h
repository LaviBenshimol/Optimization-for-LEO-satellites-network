...
class Packet : public ::omnetpp::cPacket
{
  ...
  public:
    ...
    void setTopologyVar(omnetpp::cTopology *tp);
    omnetpp::cTopology * getTopologyVar();
    int gethasInitTopo();
    void sethasInitTopo(int has);
    int getpacketType();
    void setpacketType(int packType);
};
